...
class CardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WacTechWebBundle:Card')->findAll();

        return $this->render('WacTechWebBundle:Card:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WacTechWebBundle:Card:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WacTechWebBundle:Card')->find($id);
        ...
        return $this->render('WacTechWebBundle:Card:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WacTechWebBundle:Card:edit.html.twig', array(
            'entity'      => $entity,
