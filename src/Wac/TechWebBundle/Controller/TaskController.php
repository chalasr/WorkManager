...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WacTechWebBundle:Task')->findAll();

        return $this->render('WacTechWebBundle:Task:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WacTechWebBundle:Task:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('WacTechWebBundle:Task:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WacTechWebBundle:Task:edit.html.twig', array(
            'entity'      => $entity,
